...
![Horse populations for all provinces in Canada from 1906–1972.](../results/horse_pops_plot.png){#fig-horse-all width=100%}
...
We present these standard deviations in @tbl-sd.
...
# Save into Python session (global namespace)
...
Additionally, note that in @tbl-sd we consider the sample standard deviation 
of the number of horses during the same time span as @fig-horse-all.
